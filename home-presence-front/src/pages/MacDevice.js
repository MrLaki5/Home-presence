...
class MacDevice extends React.Component {
  ...
  getData() {
    ...
    xhr.addEventListener("load", () => {
      ...
      if (data_obj["status"] === "success") {
        if (
          data_obj.hasOwnProperty("times") &&
          data_obj.hasOwnProperty("count")
        ) {
          this.setState((state) => ({
    ...
    var params =
      ...
      "&time_group=" +
      this.state.time_group +
      "&per_page=" +
      this.state.row_per_page +
      "&page_num=" +
  ...
  sendNameChange() {
    ...
    var params =
      "name=" + this.state.name + "&mac=" + this.props.location.state.mac;
    console.log(params);
    // open the request with the verb and the url
    xhr.open(
      "POST",
            ...
            <Hidden only={["xs", "sm"]}>
              ...
              <Button
                ...
                style={{
                  ...
                  color: "var(--main-bg-color)",
                  backgroundColor: "var(--main-primary-color)",
                  opacity: this.state._1h_opacity,
                }}
                onClick={() => this.handleClickTime("1h")}
              >
                Hour
              </Button>
            </Hidden>
            ...
            <Hidden only={["xs", "sm"]}>
              ...
              <Button
                ...
                style={{
                  ...
                  color: "var(--main-bg-color)",
                  backgroundColor: "var(--main-primary-color)",
                  opacity: this.state._24h_opacity,
                }}
                onClick={() => this.handleClickTime("24h")}
              >
                Day
              </Button>
            </Hidden>
            ...
            <Hidden only={["xs", "sm"]}>
              ...
              <Button
                ...
                style={{
                  ...
                  color: "var(--main-bg-color)",
                  backgroundColor: "var(--main-primary-color)",
                  opacity: this.state._1m_opacity,
                }}
                onClick={() => this.handleClickTime("1m")}
              >
                Month
              </Button>
            </Hidden>
            ...
            <Hidden only={["xs", "sm"]}>
              ...
              <Button
                ...
                style={{
                  ...
                  color: "var(--main-bg-color)",
                  backgroundColor: "var(--main-primary-color)",
                  opacity: this.state._1y_opacity,
                }}
                onClick={() => this.handleClickTime("1y")}
              >
                Year
              </Button>
            </Hidden>
              ...
              >
                ...
                >
                  <TableRow>
                    <Hidden only={["xs", "sm"]}>
                      {/* Button PC */}
                      <TableCell style={{ fontSize: "1vw" }} align="center">
                        Active times
                      </TableCell>
                    </Hidden>
                    <Hidden only={["md", "lg", "xl"]}>
                      {/* Button Mobile */}
                      <TableCell style={{ fontSize: "3vw" }} align="center">
                        Active times
                      </TableCell>
                    </Hidden>
                  </TableRow>
